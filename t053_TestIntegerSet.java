			...
			if(temp == 1) {
				...
				if(optionMenu == 1) {
					...
					do {
						...
						optionModify = scan.next();
						
						if(optionModify.equals("d")) {
							temp = 2;
							break;
						}
						if(optionModify.equals("a")) {
						...
						if(optionModify.equals("b")) {
							objA.output();
						}
						if(optionModify.equals("c")) {
							System.out.print("Delete:");
							int d2 = scan.nextInt();
							objA.delete(d2);
						}
					}while(optionModify.equals("d") != true);
				}
				if(optionMenu == 2) {
					char optionModify;
					do {
